    ...
    $(document).ready(function () {
        $.ajax({
            ...
            if (no == 1) {
                ...
                var no_last = no - 1;
                link.setAttribute("href", "airfoils.html?prefix=" + prefix + '&no=' + no_last);
            }
            ...
            for (var i = 1; i <= countItem; i++) {
                ...
                link.setAttribute("href", "airfoils.html?prefix=" + prefix + '&no=' + i);
            ...
            if (no == countItem) {
                ...
                var no_next = no + 1;
                link.setAttribute("href", "airfoils.html?prefix=" + prefix + '&no=' + no_next);
            }
            item.appendChild(link);
            cursor.appendChild(item);
